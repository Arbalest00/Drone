...
void AnoOF_DataAnl(uint8_t *data_buf, uint8_t num) {
  ...
  //		{
  //			OF_ATT_ROL = ((int16_t)(*(data_buf+5)<<8)|*(data_buf+6)) *
  //0.01 ; 			OF_ATT_PIT =
  //((int16_t)(*(data_buf+7)<<8)|*(data_buf+8)) * 0.01 ; 			OF_ATT_YAW =
  //((int16_t)(*(data_buf+9)<<8)|*(data_buf+10)) * 0.01
  //;
  //		}
  //		else if(*(data_buf+4)==1)//四元数格式
  //		{
  //			OF_ATT_S1 = ((int16_t)(*(data_buf+5)<<8)|*(data_buf+6)) *
  //0.0001 ; 			OF_ATT_S2 =
  //((int16_t)(*(data_buf+7)<<8)|*(data_buf+8)) * 0.0001 ; 			OF_ATT_S3 =
  //((int16_t)(*(data_buf+9)<<8)|*(data_buf+10)) * 0.0001 ;
